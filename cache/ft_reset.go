...
*/
func (c *Cache) ResetFT(maxWords int, maxSizeBytes uintptr, schema map[string]bool) error {
	c.mutex.Lock()
...
*/
func (c *Cache) ResetFTWithMap(data map[string]map[string]interface{}, maxWords int, maxSizeBytes uintptr, schema map[string]bool) error {
	c.mutex.Lock()
	defer c.mutex.Unlock()
...
*/
func (c *Cache) ResetFTWithJson(file string, maxWords int, maxSizeBytes uintptr, schema map[string]bool) error {
	c.mutex.Lock()
	defer c.mutex.Unlock()
